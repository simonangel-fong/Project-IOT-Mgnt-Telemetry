# IoT Management Telemetry - FastAPI

[Back](../../README.md)

- [IoT Management Telemetry - FastAPI](#iot-management-telemetry---fastapi)
...
```sh
# aws ecr delete-repository --repository-name iot-mgnt-telemetry-fastapi --region ca-central-1
